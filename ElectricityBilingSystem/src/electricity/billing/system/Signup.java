...
public class Signup extends JFrame implements ActionListener {
        ...
        meter.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent fe) {
                try {
                    ...
                    PreparedStatement ps = conn.prepareStatement("select * from login where meter_no = ?");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == create) {
            ...
            if (susername.isEmpty() ||  spassword.isEmpty() || (atype.equals("Customer") && smeter.isEmpty())) {
            ...
            try {
                ...
                if (atype.equals("Admin")) {
                    PreparedStatement ps = conn.prepareStatement("insert into login (username, name, password, user) values (?, ?, ?, ?)");
                    ...
                    PreparedStatement ps = conn.prepareStatement("update login set username = ?, password = ?, user = ? where meter_no = ?");
                    ps.setString(1, susername);
